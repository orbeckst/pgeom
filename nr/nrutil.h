/* nrutil.h
   ...
   from online 'Numerical Recipes in C'
   http://www.library.cornell.edu/nr/bookcpdf.html

   (copy & paste from 
   http://www.library.cornell.edu/nr/bookcpdf/c21-1.pdf )

*/

#include "nr.h"

/* always use the ansi declarations */
#define NRANSI
...
real **submatrix(real **a, long oldrl, long oldrh, long oldcl, long oldch, long newrl, long newcl);
